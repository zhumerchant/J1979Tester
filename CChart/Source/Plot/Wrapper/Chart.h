...
CChart_API	HWND	CreatePopupChartWndWithMsgLoop(HWND hWndParent, int nChartType, TCHAR *wndTitle, int x=0, int y=0, int cx=CW_USEDEFAULT, int cy=CW_USEDEFAULT);
